...
$wrapper .= '<input type="'.$btype.'" id="'.$divid.'_btn" value="'.$options[0]['button'].'" alt="[Submit]" class="usfbtn '.$bclass.'" />';


$wrapper .= '<input type="button" id="'.$divid.'_btn" value="Zur&#252;cksetzen" alt="[Reset]" class="usfbtn '.$bclass.'" style="margin-left:5%"  onclick="resetForm()" /></div>';
$wrapper .= '<script>function resetForm() {
  document.getElementById("uwpqsffrom_'.$id.'").reset();
}
</script>';
